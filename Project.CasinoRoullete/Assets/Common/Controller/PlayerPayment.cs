...
public class PlayerPayment : Singlenton<PlayerPayment>
{
    ...
    private int paymentPlenos()
    {
        ...
        foreach(var element in _fichasWinnerPlenos)
        {
            ...
            //string key = scFichas.GetKeyFicha();
            switch ("key")
            {
                case "Numero":
    ...
    {
        PlayerPayment.Instance._fichasWinnerPlenos.Clear();
        PlayerPayment.Instance._fichasWinnerMedios.Clear();
        PlayerPayment.Instance._fichasLosted.Clear();
    }
    ...
    public void saveRounded()
    {
        ...
        foreach (var ficha in _fichasPrevious)
        {
            ...
            if (ficha.GetComponent<FichaDisplay>().currentButton.isPleno)
            {
